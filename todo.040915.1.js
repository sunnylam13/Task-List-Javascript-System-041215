...
// 				// // retrieve the unique key name of the to do item from the array
// 				// var key = toDoArray[index].taskKey;
// 				// console.log('To Do Key: ', key);

// 				// // use key to acquire localStorage item
// 				// var value = localStorage[key];
// 				// console.log('To Do Name: ', value);

// 				// change the task status to "todo"
// 				// this is done before you create the to do
// 				toDoArray[index].taskStatus = "todo";
...
// 	if (doneTaskArray) {
// 		$.each(doneTaskArray, function(index, val) {
// 				// // retrieve the unique key name of the to do item from the array
// 				// var key = doneTaskArray[index].taskKey;
// 				// console.log('To Do Key: ', key);
...
// 				doneTaskArray[index].taskStatus = "done";

// 				// pass the object to function to create the note
// 				recreateToDo041315a(doneTaskArray[index]);
// 			});
// 	}
// }
...
// 	// WARNING:  you've designed this to take either 3 args or none... in the case of new items if you supply the status only you will mess up the args as it was expecting a key as the first arg...  I suppose I could pass null as the first 2 args and then pass status
// 	// passing a single object as an argument would be so much easier as you could alter the state of the object and it's all stored inside of it
...
// function getDeletedTaskArray () {
// 	// we need a done task rolodex or tracker so we can re-populate the Completed Task list later on
	
// 	var deleteTaskArray = localStorage["deleteTaskArray"];
...
// 		deleteTaskArray = [];
// 		// use JSON.stringify(ARRAY)
// 		localStorage.setItem("deleteTaskArray", JSON.stringify(deleteTaskArray));
// 	} else {
// 		// else deleteTaskArray exists so you'll need to convert it from json string to array
// 		deleteTaskArray = JSON.parse(deleteTaskArray);
// 	}

// 	// we'll be using this inside other functions
// 	// return the value so you can use result
// 	return deleteTaskArray;
// }
...
// drop changeArray or comment it out
// function changeArray (arrayChoice, action, taskKeyID) {
// 	switch(arrayChoice) {
// 		case "todo":
...
// 				// $.each(toDoArray, function(index, val) {
// 				// 	if (toDoArray.taskKey == taskKeyID) {
// 				// 		toDoArray.push($taskItemObject041315);
// 				// 	}
// 				// });

// 				// push the currently removed item into the array
// 				toDoArray.push($taskItemObject041315);
...
// 				$.each(toDoArray, function(index, val) {
// 					if (toDoArray.taskKey == taskKeyID) {
// 						// remove the object and store it with detach
// 						$taskItemObject041315 = toDoArray[index];
...
// 			if (action=="add") {
// 				// $.each(doneTaskArray, function(index, val) {
// 				// 	if (doneTaskArray.taskKey == taskKeyID) {
// 				// 		doneTaskArray.push($taskItemObject041315);
// 				// 	}
// 				// });
...
// 					if (doneTaskArray.taskKey == taskKeyID) {
// 						// remove the object and store it with detach
// 						$taskItemObject041315 = doneTaskArray[index];
